...
.get((req,res) => {
    if(req.query.type != undefined){
        ...
        res.status(200).json({message: "Loading all novels by type " + req.query.type, data: searchByType})
    }
    else{
...
.get((req,res) => {
    ...
    res.status(200).json({message: "Loading all novels with the matching title " + req.params.title, data: searchByTitle})
})
